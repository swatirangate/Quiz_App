...
public class CppLangActivity extends AppCompatActivity implements View.OnClickListener {

    TextView text_question,total_question;
    Button btn_choose1,btn_choose2,btn_choose3,btn_choose4,btn_next;
    int score=0;
    int totalQuestion = CppQuestionAnswer.question.length;
    ...
    public void onClick(View view) {
        ...
        if(clickedButton.getId()==R.id.btn_next){
            ...
            if(selectedAnswer.equals(CppQuestionAnswer.correctAnswer[currentQuestionIndex])){
                score++;
            }
    ...
    void loadNewQuestion() {
        ...
        text_question.setText(CppQuestionAnswer.question[currentQuestionIndex]);
        btn_choose1.setText(CppQuestionAnswer.choices[currentQuestionIndex][0]);
        btn_choose2.setText(CppQuestionAnswer.choices[currentQuestionIndex][1]);
        btn_choose3.setText(CppQuestionAnswer.choices[currentQuestionIndex][2]);
        btn_choose4.setText(CppQuestionAnswer.choices[currentQuestionIndex][3]);
