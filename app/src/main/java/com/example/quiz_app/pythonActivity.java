...
public class pythonActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if(clickedButton.getId()==R.id.btn_next){
            ...
            if(selectedAnswer.equals(pythonQuestionAnswer.correctAnswer[currentQuestionIndex])){
                score++;
            }
    ...
    void loadNewQuestion() {
        ...
        text_question.setText(pythonQuestionAnswer.question[currentQuestionIndex]);
        btn_choose1.setText(pythonQuestionAnswer.choices[currentQuestionIndex][0]);
        btn_choose2.setText(pythonQuestionAnswer.choices[currentQuestionIndex][1]);
        btn_choose3.setText(pythonQuestionAnswer.choices[currentQuestionIndex][2]);
        btn_choose4.setText(pythonQuestionAnswer.choices[currentQuestionIndex][3]);
